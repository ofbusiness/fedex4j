...
public class ServiceType implements java.io.Serializable {
    ...
    public static final String _FEDEX_INTERNATIONAL_PRIORITY_PLUS = "FEDEX_INTERNATIONAL_PRIORITY_PLUS";
    ...
    public static final String _SAME_DAY_METRO_AFTERNOON = "SAME_DAY_METRO_AFTERNOON";
    public static final String _SAME_DAY_METRO_MORNING = "SAME_DAY_METRO_MORNING";
    public static final String _SAME_DAY_METRO_RUSH = "SAME_DAY_METRO_RUSH";
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/pickup/v11", "ServiceType"));
    }
    /**
