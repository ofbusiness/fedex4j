...
public class EMailNotificationDetail  implements java.io.Serializable {
    ...
    private com.fedex.pickup.stub.EMailNotificationAggregationType aggregationType;
    ...
    private com.fedex.pickup.stub.EMailNotificationRecipient[] recipients;

    public EMailNotificationDetail() {
    }

    public EMailNotificationDetail(
           com.fedex.pickup.stub.EMailNotificationAggregationType aggregationType,
           String personalMessage,
           com.fedex.pickup.stub.EMailNotificationRecipient[] recipients) {
     ...
     */
    public com.fedex.pickup.stub.EMailNotificationAggregationType getAggregationType() {
     ...
     */
    public void setAggregationType(com.fedex.pickup.stub.EMailNotificationAggregationType aggregationType) {
        this.aggregationType = aggregationType;
    }
     ...
     * of the email and events to be notified on
     */
    public com.fedex.pickup.stub.EMailNotificationRecipient[] getRecipients() {
        return recipients;
    }
     ...
     * of the email and events to be notified on
     */
    public void setRecipients(com.fedex.pickup.stub.EMailNotificationRecipient[] recipients) {
        this.recipients = recipients;
    }

    public com.fedex.pickup.stub.EMailNotificationRecipient getRecipients(int i) {
        return this.recipients[i];
    }

    public void setRecipients(int i, com.fedex.pickup.stub.EMailNotificationRecipient _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/pickup/v11", "EMailNotificationDetail"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("aggregationType");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/pickup/v11", "AggregationType"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/pickup/v11", "EMailNotificationAggregationType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("personalMessage");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/pickup/v11", "PersonalMessage"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/pickup/v11", "EMailNotificationRecipient"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
