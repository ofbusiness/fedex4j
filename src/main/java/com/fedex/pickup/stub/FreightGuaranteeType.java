...
public class FreightGuaranteeType implements java.io.Serializable {
    ...
    public static final String _GUARANTEED_TIME = "GUARANTEED_TIME";
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/pickup/v11", "FreightGuaranteeType"));
    }
    /**
