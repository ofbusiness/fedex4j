...
public class ModifyPackageInOpenShipmentActionType implements java.io.Serializable {
    ...
    // Constructor
    protected ModifyPackageInOpenShipmentActionType(String value) {
        _value_ = value;
    ...
    public static ModifyPackageInOpenShipmentActionType fromValue(String value)
    ...
    public static ModifyPackageInOpenShipmentActionType fromString(String value)
          throws IllegalArgumentException {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v9", "ModifyPackageInOpenShipmentActionType"));
    }
    /**
