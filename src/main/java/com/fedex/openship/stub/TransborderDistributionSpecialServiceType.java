...
public class TransborderDistributionSpecialServiceType implements java.io.Serializable {
    ...
    // Constructor
    protected TransborderDistributionSpecialServiceType(String value) {
        _value_ = value;
        _table_.put(_value_,this);
    }

    public static final String _FEDEX_LTL = "FEDEX_LTL";
    ...
    public static TransborderDistributionSpecialServiceType fromValue(String value)
    ...
    public static TransborderDistributionSpecialServiceType fromString(String value)
          throws IllegalArgumentException {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v9", "TransborderDistributionSpecialServiceType"));
    }
    /**
