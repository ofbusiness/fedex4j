...
public class EMailLabelDetail  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v9", "EMailLabelDetail"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v9", "EMailRecipient"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
