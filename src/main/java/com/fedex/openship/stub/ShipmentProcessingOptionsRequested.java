...
public class ShipmentProcessingOptionsRequested  implements java.io.Serializable {
    ...
    private ShipmentProcessingOptionType[] options;

    public ShipmentProcessingOptionsRequested() {
    }

    public ShipmentProcessingOptionsRequested(
           ShipmentProcessingOptionType[] options) {
     ...
     */
    public ShipmentProcessingOptionType[] getOptions() {
        return options;
    }
     ...
     */
    public void setOptions(ShipmentProcessingOptionType[] options) {
        this.options = options;
    }

    public ShipmentProcessingOptionType getOptions(int i) {
        return this.options[i];
    }

    public void setOptions(int i, ShipmentProcessingOptionType _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v9", "ShipmentProcessingOptionsRequested"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("options");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v9", "Options"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v9", "ShipmentProcessingOptionType"));
