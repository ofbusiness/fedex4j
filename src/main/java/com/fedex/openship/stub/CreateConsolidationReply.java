...
public class CreateConsolidationReply  implements java.io.Serializable {
    ...
    public synchronized int hashCode() {
        ...
        if (getEffectiveDistributionLocations() != null) {
            for (int i=0;
                 ...
                 i++) {
                Object obj = java.lang.reflect.Array.get(getEffectiveDistributionLocations(), i);
                if (obj != null &&
                    !obj.getClass().isArray()) {
                    _hashCode += obj.hashCode();
                }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v9", "CreateConsolidationReply"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v9", "EffectiveDistributionLocations"));
