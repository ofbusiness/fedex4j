...
public class GetConfirmConsolidationResultsReply  implements java.io.Serializable {
    ...
    private CompletedConsolidationDetail completedConsolidationDetail;
    ...
    public GetConfirmConsolidationResultsReply(
           ...
           VersionId version,
           CompletedConsolidationDetail completedConsolidationDetail) {
     ...
     */
    public void setCompletedConsolidationDetail(CompletedConsolidationDetail completedConsolidationDetail) {
        this.completedConsolidationDetail = completedConsolidationDetail;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/openship/v9", "GetConfirmConsolidationResultsReply"));
