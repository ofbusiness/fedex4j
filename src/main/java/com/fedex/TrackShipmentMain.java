 ...
 */
public class TrackShipmentMain {
	//
	public static void main(String[] args) throws Exception {   
        ...
        packageIdentifier.setValue("794698475008"); // tracking number 776311527591,776288416475
		...
		try {
		    ...
		    //
			TrackReply reply = port.track(request); // This is the call to the web service passing in a request object
	...
	private static ClientDetail createClientDetail() {
        ...
        if (accountNumber == null) {
        	accountNumber = "510087984"; // Replace "XXX" with clients account number
        }
        if (meterNumber == null) {
        	meterNumber = "118724827"; // Replace "XXX" with clients meter number
        }
	...
	private static WebAuthenticationDetail createWebAuthenticationDetail() {
        ...
        //
        if (key == null) {
        	key = "8fM8x9uNsUSLEIfO"; // Replace "XXX" with clients key
        }
        if (password == null) {
        	password = "34ymdcY7vHEpBf347x9CClUXT"; // Replace "XXX" with clients password
        }
