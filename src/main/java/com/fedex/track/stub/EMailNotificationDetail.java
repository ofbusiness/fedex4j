...
public class EMailNotificationDetail  implements java.io.Serializable {
    ...
    private EMailNotificationRecipient[] recipients;
    ...
    public EMailNotificationDetail(
           ...
           EMailNotificationRecipient[] recipients) {
     ...
     * of the email and events to be notified on
     */
    public EMailNotificationRecipient[] getRecipients() {
        return recipients;
    }
     ...
     * of the email and events to be notified on
     */
    public void setRecipients(EMailNotificationRecipient[] recipients) {
        this.recipients = recipients;
    }

    public EMailNotificationRecipient getRecipients(int i) {
        return this.recipients[i];
    }

    public void setRecipients(int i, EMailNotificationRecipient _value) {
